...
const privateKey = '0xd3d0d94035b81e3200eb070ee3250e7e567a0f97d1ad15f333860a292e5c7c20';
const privateKeyOwner = '0xd3d0d94035b81e3200eb070ee3250e7e567a0f97d1ad15f333860a292e5c7c20';
const provider = new ethers.providers.JsonRpcProvider(config.networkUrl)
const owner = new ethers.Wallet(privateKeyOwner, provider);
...
async function createOrder(){
    ...
    // console.log(req);
    const signedTx = await trader.signTransaction(req);
